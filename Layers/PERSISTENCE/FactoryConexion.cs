...
class FactoryConexion
{
    ...
    public static string CreateConnection()
    {
        ...
        {
            if (ConfigurationManager.ConnectionStrings[i].Name.Equals("winShootForItAuctions.Properties.Settings.ShootForItConexion", StringComparison.InvariantCultureIgnoreCase))
                existe = true;
        }
        ...
        conexion.AppendFormat("{0}", ConfigurationManager.ConnectionStrings["winShootForItAuctions.Properties.Settings.ShootForItConexion"].ConnectionString);
